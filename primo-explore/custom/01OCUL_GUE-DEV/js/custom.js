...
// setup our module to all access to UG API
  ...
  askus.setAttribute('data-askus-popout-state', 'collapsed'); 
  askus.innerHTML = '<a class="tab-head" href="javascript:void()" ><img src="custom/01OCUL_GUE-DEV/img/speech-bubble_white-fill-small.png" alt="">Chat with us</a> \
  <div class="askus_tab"> \
  <!--<h2 class="askus_centre">Chat With Us</h2>--><!--Chat Button BEGIN--> \
      <div class="needs-js">chat loading...</div> \
      <!--Guelph --><!--Chat Button END--><!--<p><a href="https://www.lib.uoguelph.ca/ask-us/comments/"><img alt="Chat Offline" class="center" src="custom/01OCUL_GUE-DEV/img/guelph_offline.gif" /></a></p>--> \
      <ul> \
